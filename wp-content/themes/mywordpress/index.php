                  ...
                  <div class="container padding">
                  	<div class="row">
                        ...
                        <div class="col-lg-8 col-sm-8">
                          ...
                          <h3 class="center-bottom">Farlig gods merking av Intermodale containere</h3>
                        </div>
                      <div class="col-lg-2 col-sm-2">
                      ...
                      <div class="col-lg-6 col-sm-6">
                        <div class="para-right">
                          <div class="para">
                            ...
                            <p>Med Vacuro´s patenterte holdere for faresedler går merking av containere med farlig gods lekende lett.<br>
                               Limfrie faresedler settes inn og tas ut av holderne i en håndvending.</p>
                            <h4>Systemet gir derfor transportører:</h4>
                            <ul>
                         ...
                         <div class="col-lg-6 col-sm-6">
                           <div class="para">
                                ...
                                <p><span class="shorttext">Vacu</span>, som betyr: <strong>“være tom”</strong>, “være ledig”, “være åpen”. Vacu beskriver selve merkeholderen – merkeholderne har ledig plass for å sette inn faresedler.</p>
